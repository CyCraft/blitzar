...
It is still possible to make this re-usable throughout your app! You can create a "wrapper component" that wraps `<BlitzTable />` and adds your custom style and title sections.

To make sure you can still use any BlitzTable props on your wrapper component, you can simply pass all `$attrs` to BlitzTable. Check the "script tab" of this example to see how this is done.
 */
export default {

      ...
      >
        ...
        >
          ...
          <EasyCell
            ...
            :value="getProp(EasyFormSimulatedContext.formData, blueprint.id)"
...
import { EfBtn, EasyForm } from '@blitzar/form'
...
export default {
  ...
  props: {
    // EasyTable props:
    /**
     * The schema for the columns you want to generate. (EasyForm schema format)
    ...
    /**
     * The schema for the grid cards you want to generate. (EasyForm schema format)
     * @category column
     */
    ...
    /**
     * The EasyForm options you want to use for the grid cards.
     *
     * Please note:
     ...
     * @category column
     */
    gridEasyFormOptions: { type: Object, default: () => ({}) },
    /**
    ...
    /**
     * Check the description at EasyRow.vue
     * @category style
     */
    rowClasses: {},
    /**
    ...
    title: { type: String },
    /**
     * This is fixed to `id` in an EasyTable and cannot be changed.
     * @category modified prop
     */
    rowKey: {},
  },

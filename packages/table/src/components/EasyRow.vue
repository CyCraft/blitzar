...
export default {
  ...
  props: {
    ...
    /**
     * Custom styling to be applied to the EasyRow. Applied like so `:style="rowStyle"`
     * @example 'padding: 1em;'
     * @category style
     */
    rowStyle: { type: [Object, Array, String, Function] },
    /**
     * Custom classes to be applied to the EasyRow. Applied like so `:class="rowClasses"`
     * @example ['dark-theme']
     * @category style
     */
